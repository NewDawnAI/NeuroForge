...
## Phase 15 Ethics Regulation Parameters

These parameters control the Phase 15 ethics regulation system, which provides real-time safety enforcement for autonomous actions.

### `--phase15`
- **Type**: flag
- **Default**: `off`
- **Purpose**: Enable Phase 15 Ethics Regulation.
- **Effect**: Activates the `Phase15EthicsRegulator` to intercept and evaluate all proposed actions against safety guidelines.

### `--phase15-risk-threshold <value>`
- **Type**: `double`
- **Default**: `0.5`
- **Range**: `0.0 - 1.0`
- **Purpose**: Set the risk tolerance threshold.
- **Effect**: Actions with a risk score above this value are denied or flagged for review.
  - Risk < Threshold - Margin: **Allow**
  - Risk > Threshold + Margin: **Deny**
  - Otherwise: **Review**
